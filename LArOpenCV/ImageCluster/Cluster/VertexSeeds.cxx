...
namespace larocv {
					  ...
					  ROI& roi)
  {
    ...
    auto & vtx_seeds = AlgoData<data::VertexSeedsData>(0);
    ...
    for (const auto& ctor : ctor_arr_v) {
      ...
      vtx_seeds._cluscomp_v.emplace_back(cluscomp);
      ...
      for(const auto& inter_ : intersections) vtx_seeds._pca_v.emplace_back(inter_);
