...
namespace larcv {
  ...
  */
  ...
  /**
     ...
     a static std::map. Use static method to get a static instance (larcv::MatchAlgoFactory::get) \n
     to access a factory.
  */
  ...
  public:
    ...
    void add_factory(const std::string name, larcv::MatchAlgoFactoryBase* factory)
  ...
  private:
    ...
    std::map<std::string,larcv::MatchAlgoFactoryBase*> _factory_map;
    /// Static self
